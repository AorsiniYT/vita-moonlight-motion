...
#define MENU_MESSAGE(MESSAGE) \
  ...
  MENU_ENTRY(SETTINGS_MOTION_CONTROLS_SCALAR_X, SETTINGS_VIEW_MOTION_CONTROLS_SCALAR_X, "Motion controls sensitivity scale X", "");
  MENU_ENTRY(SETTINGS_MOTION_CONTROLS_SCALAR_Y, SETTINGS_VIEW_MOTION_CONTROLS_SCALAR_Y, "Motion controls sensitivity scale Y", "");
